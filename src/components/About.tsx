  ...
  return <div id="about">
    <div className="container">
      ...
      <div className="body">
        ...
        <p>This website was written in React with Typescript. All photos are uploaded on Amazon S3 and served by CloudFront, the album info is stored on Cloudant DBaaS, and the site is hosted on IBM Bluemix.</p>
